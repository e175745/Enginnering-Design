...
class FightingScene: GameSceneBase {
    ...
    private func start(){
        ...
        self.fishsize1 = Float(round(self.gameStatus.FishSize / 8))
...
//                print(self.gameStatus.FishRarity,self.gameStatus.FishSize)
    ...
    self.visualizer.showImage(name:"tap_only.png",position:CGPoint(x:80,y:750),size:CGSize(width:210,height:200),showTime:0.1)
            return nil
        }
    }
}
